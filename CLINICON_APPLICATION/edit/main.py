...
def myProfile(res):
    ...
    plan=Label(frame3,text="Blood Group: ",bg="#142850",fg="#2ec1ac",font=("Ubuntu",16,"bold"),anchor=W)
    ...
    plan_p=Label(frame3,text="O+",bg="#142850",fg="#ffffff",font=("Ubuntu",16,"bold"),anchor=W)
