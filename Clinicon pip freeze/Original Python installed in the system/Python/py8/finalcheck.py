...
#mycursor.execute("CREATE TABLE ress(id INT AUTO_INCREMENT PRIMARY KEY,Name VARCHAR(255), Address VARCHAR(255), Rating FLOAT(2), Vote INT(255), Area VARCHAR(255), TypeOfRestaurant VARCHAR(255), Contact VARCHAR(255),Cuisines VARCHAR(255))")
sql = "INSERT INTO ress (Name,Address,Rating,Vote,Area,TypeOfRestaurant,Contact,Cuisines) VALUES (%s,%s,%s,%s,%s,%s,%s,%s)"
