...
mycursor.execute("CREATE TABLE finn(id INT AUTO_INCREMENT PRIMARY KEY,Name VARCHAR(255), Address VARCHAR(255), Rating FLOAT(2), Vote INT(255), Area VARCHAR(255), TypeOfRestaurant VARCHAR(255), Cuisines VARCHAR(255),Fin VARCHAR(255))")
sql = "INSERT INTO finn (Name,Address,Rating,Vote,Area,TypeOfRestaurant,Cuisines,Fin) VALUES (%s,%s,%s,%s,%s,%s,%s,%s)"
